...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('6k4s-JnDzu', 0, 'ww-fmFkOvG-QydejH38dng', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getCacheClearerService()
    {
        ...
        $b->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('S944vUsgVQ', 0, 'ww-fmFkOvG-QydejH38dng', (__DIR__.'/pools'), $a));
        $b->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('V-iyTyxGOs', 0, 'ww-fmFkOvG-QydejH38dng', (__DIR__.'/pools'), $a));
    ...
    public function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['doctrine.orm.default_entity_manager'] = DoctrineORMEntityManager_0000000024f6fee90000000002ea265b5c29690a497b88b5506386156271a85b::staticProxyConstructor(
    ...
    protected function getSecurity_Firewall_Map_Context_SecuredAreaService()
    {
        ...
        return $this->services['security.firewall.map.context.secured_area'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($i, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $this->get('security.user.provider.concrete.database_users')), 'secured_area', $a, $c, $d), 2 => $k, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $g, new \Symfony\Component\Security\Http\Session\SessionAuthenticationStrategy('migrate'), $j, 'secured_area', $l, $m, array('check_path' => 'security_login', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'authenticate', 'post_only' => true), $a, $c, $this->get('security.csrf.token_manager')), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '584877d075fa61.57932700', $a, $g), 5 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('debug.security.access.decision_manager'), $i, $g)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $d, $j, 'secured_area', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($f, $j, 'security_login', false), NULL, NULL, $a, false));
    }
...
class DoctrineORMEntityManager_0000000024f6fee90000000002ea265b5c29690a497b88b5506386156271a85b extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder584877d3e750d320243087 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer584877d3e7563501587144 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties584877d3e73fb012505106 = array(
    ...
    {
        $this->initializer584877d3e7563501587144 && $this->initializer584877d3e7563501587144->__invoke($this->valueHolder584877d3e750d320243087, $this, 'getConnection', array(), $this->initializer584877d3e7563501587144);

        return $this->valueHolder584877d3e750d320243087->getConnection();
    }
    ...
    {
        $this->initializer584877d3e7563501587144 && $this->initializer584877d3e7563501587144->__invoke($this->valueHolder584877d3e750d320243087, $this, 'getMetadataFactory', array(), $this->initializer584877d3e7563501587144);

        return $this->valueHolder584877d3e750d320243087->getMetadataFactory();
    }
    ...
    {
        $this->initializer584877d3e7563501587144 && $this->initializer584877d3e7563501587144->__invoke($this->valueHolder584877d3e750d320243087, $this, 'getExpressionBuilder', array(), $this->initializer584877d3e7563501587144);

        return $this->valueHolder584877d3e750d320243087->getExpressionBuilder();
    }
    ...
    {
        $this->initializer584877d3e7563501587144 && $this->initializer584877d3e7563501587144->__invoke($this->valueHolder584877d3e750d320243087, $this, 'beginTransaction', array(), $this->initializer584877d3e7563501587144);

        return $this->valueHolder584877d3e750d320243087->beginTransaction();
    }
    ...
    {
        $this->initializer584877d3e7563501587144 && $this->initializer584877d3e7563501587144->__invoke($this->valueHolder584877d3e750d320243087, $this, 'getCache', array(), $this->initializer584877d3e7563501587144);

        return $this->valueHolder584877d3e750d320243087->getCache();
    }
    ...
    {
        $this->initializer584877d3e7563501587144 && $this->initializer584877d3e7563501587144->__invoke($this->valueHolder584877d3e750d320243087, $this, 'transactional', array('func' => $func), $this->initializer584877d3e7563501587144);

        return $this->valueHolder584877d3e750d320243087->transactional($func);
    }
    ...
    {
        $this->initializer584877d3e7563501587144 && $this->initializer584877d3e7563501587144->__invoke($this->valueHolder584877d3e750d320243087, $this, 'commit', array(), $this->initializer584877d3e7563501587144);

        return $this->valueHolder584877d3e750d320243087->commit();
    }
    ...
    {
        $this->initializer584877d3e7563501587144 && $this->initializer584877d3e7563501587144->__invoke($this->valueHolder584877d3e750d320243087, $this, 'rollback', array(), $this->initializer584877d3e7563501587144);

        return $this->valueHolder584877d3e750d320243087->rollback();
    }
    ...
    {
        $this->initializer584877d3e7563501587144 && $this->initializer584877d3e7563501587144->__invoke($this->valueHolder584877d3e750d320243087, $this, 'getClassMetadata', array('className' => $className), $this->initializer584877d3e7563501587144);

        return $this->valueHolder584877d3e750d320243087->getClassMetadata($className);
    }
    ...
    {
        $this->initializer584877d3e7563501587144 && $this->initializer584877d3e7563501587144->__invoke($this->valueHolder584877d3e750d320243087, $this, 'createQuery', array('dql' => $dql), $this->initializer584877d3e7563501587144);

        return $this->valueHolder584877d3e750d320243087->createQuery($dql);
    }
    ...
    {
        $this->initializer584877d3e7563501587144 && $this->initializer584877d3e7563501587144->__invoke($this->valueHolder584877d3e750d320243087, $this, 'createNamedQuery', array('name' => $name), $this->initializer584877d3e7563501587144);

        return $this->valueHolder584877d3e750d320243087->createNamedQuery($name);
    }
    ...
    {
        $this->initializer584877d3e7563501587144 && $this->initializer584877d3e7563501587144->__invoke($this->valueHolder584877d3e750d320243087, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializer584877d3e7563501587144);

        return $this->valueHolder584877d3e750d320243087->createNativeQuery($sql, $rsm);
    }
    ...
    {
        $this->initializer584877d3e7563501587144 && $this->initializer584877d3e7563501587144->__invoke($this->valueHolder584877d3e750d320243087, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializer584877d3e7563501587144);

        return $this->valueHolder584877d3e750d320243087->createNamedNativeQuery($name);
    }
    ...
    {
        $this->initializer584877d3e7563501587144 && $this->initializer584877d3e7563501587144->__invoke($this->valueHolder584877d3e750d320243087, $this, 'createQueryBuilder', array(), $this->initializer584877d3e7563501587144);

        return $this->valueHolder584877d3e750d320243087->createQueryBuilder();
    }
    ...
    {
        $this->initializer584877d3e7563501587144 && $this->initializer584877d3e7563501587144->__invoke($this->valueHolder584877d3e750d320243087, $this, 'flush', array('entity' => $entity), $this->initializer584877d3e7563501587144);

        return $this->valueHolder584877d3e750d320243087->flush($entity);
    }
    ...
    {
        $this->initializer584877d3e7563501587144 && $this->initializer584877d3e7563501587144->__invoke($this->valueHolder584877d3e750d320243087, $this, 'find', array('entityName' => $entityName, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer584877d3e7563501587144);

        return $this->valueHolder584877d3e750d320243087->find($entityName, $id, $lockMode, $lockVersion);
    }
    ...
    {
        $this->initializer584877d3e7563501587144 && $this->initializer584877d3e7563501587144->__invoke($this->valueHolder584877d3e750d320243087, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializer584877d3e7563501587144);

        return $this->valueHolder584877d3e750d320243087->getReference($entityName, $id);
    }
    ...
    {
        $this->initializer584877d3e7563501587144 && $this->initializer584877d3e7563501587144->__invoke($this->valueHolder584877d3e750d320243087, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializer584877d3e7563501587144);

        return $this->valueHolder584877d3e750d320243087->getPartialReference($entityName, $identifier);
    }
    ...
    {
        $this->initializer584877d3e7563501587144 && $this->initializer584877d3e7563501587144->__invoke($this->valueHolder584877d3e750d320243087, $this, 'clear', array('entityName' => $entityName), $this->initializer584877d3e7563501587144);

        return $this->valueHolder584877d3e750d320243087->clear($entityName);
    }
    ...
    {
        $this->initializer584877d3e7563501587144 && $this->initializer584877d3e7563501587144->__invoke($this->valueHolder584877d3e750d320243087, $this, 'close', array(), $this->initializer584877d3e7563501587144);

        return $this->valueHolder584877d3e750d320243087->close();
    }
    ...
    {
        $this->initializer584877d3e7563501587144 && $this->initializer584877d3e7563501587144->__invoke($this->valueHolder584877d3e750d320243087, $this, 'persist', array('entity' => $entity), $this->initializer584877d3e7563501587144);

        return $this->valueHolder584877d3e750d320243087->persist($entity);
    }
    ...
    {
        $this->initializer584877d3e7563501587144 && $this->initializer584877d3e7563501587144->__invoke($this->valueHolder584877d3e750d320243087, $this, 'remove', array('entity' => $entity), $this->initializer584877d3e7563501587144);

        return $this->valueHolder584877d3e750d320243087->remove($entity);
    }
    ...
    {
        $this->initializer584877d3e7563501587144 && $this->initializer584877d3e7563501587144->__invoke($this->valueHolder584877d3e750d320243087, $this, 'refresh', array('entity' => $entity), $this->initializer584877d3e7563501587144);

        return $this->valueHolder584877d3e750d320243087->refresh($entity);
    }
    ...
    {
        $this->initializer584877d3e7563501587144 && $this->initializer584877d3e7563501587144->__invoke($this->valueHolder584877d3e750d320243087, $this, 'detach', array('entity' => $entity), $this->initializer584877d3e7563501587144);

        return $this->valueHolder584877d3e750d320243087->detach($entity);
    }
    ...
    {
        $this->initializer584877d3e7563501587144 && $this->initializer584877d3e7563501587144->__invoke($this->valueHolder584877d3e750d320243087, $this, 'merge', array('entity' => $entity), $this->initializer584877d3e7563501587144);

        return $this->valueHolder584877d3e750d320243087->merge($entity);
    }
    ...
    {
        $this->initializer584877d3e7563501587144 && $this->initializer584877d3e7563501587144->__invoke($this->valueHolder584877d3e750d320243087, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializer584877d3e7563501587144);

        return $this->valueHolder584877d3e750d320243087->copy($entity, $deep);
    }
    ...
    {
        $this->initializer584877d3e7563501587144 && $this->initializer584877d3e7563501587144->__invoke($this->valueHolder584877d3e750d320243087, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer584877d3e7563501587144);

        return $this->valueHolder584877d3e750d320243087->lock($entity, $lockMode, $lockVersion);
    }
    ...
    {
        $this->initializer584877d3e7563501587144 && $this->initializer584877d3e7563501587144->__invoke($this->valueHolder584877d3e750d320243087, $this, 'getRepository', array('entityName' => $entityName), $this->initializer584877d3e7563501587144);

        return $this->valueHolder584877d3e750d320243087->getRepository($entityName);
    }
    ...
    {
        $this->initializer584877d3e7563501587144 && $this->initializer584877d3e7563501587144->__invoke($this->valueHolder584877d3e750d320243087, $this, 'contains', array('entity' => $entity), $this->initializer584877d3e7563501587144);

        return $this->valueHolder584877d3e750d320243087->contains($entity);
    }
    ...
    {
        $this->initializer584877d3e7563501587144 && $this->initializer584877d3e7563501587144->__invoke($this->valueHolder584877d3e750d320243087, $this, 'getEventManager', array(), $this->initializer584877d3e7563501587144);

        return $this->valueHolder584877d3e750d320243087->getEventManager();
    }
    ...
    {
        $this->initializer584877d3e7563501587144 && $this->initializer584877d3e7563501587144->__invoke($this->valueHolder584877d3e750d320243087, $this, 'getConfiguration', array(), $this->initializer584877d3e7563501587144);

        return $this->valueHolder584877d3e750d320243087->getConfiguration();
    }
    ...
    {
        $this->initializer584877d3e7563501587144 && $this->initializer584877d3e7563501587144->__invoke($this->valueHolder584877d3e750d320243087, $this, 'isOpen', array(), $this->initializer584877d3e7563501587144);

        return $this->valueHolder584877d3e750d320243087->isOpen();
    }
    ...
    {
        $this->initializer584877d3e7563501587144 && $this->initializer584877d3e7563501587144->__invoke($this->valueHolder584877d3e750d320243087, $this, 'getUnitOfWork', array(), $this->initializer584877d3e7563501587144);

        return $this->valueHolder584877d3e750d320243087->getUnitOfWork();
    }
    ...
    {
        $this->initializer584877d3e7563501587144 && $this->initializer584877d3e7563501587144->__invoke($this->valueHolder584877d3e750d320243087, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializer584877d3e7563501587144);

        return $this->valueHolder584877d3e750d320243087->getHydrator($hydrationMode);
    }
    ...
    {
        $this->initializer584877d3e7563501587144 && $this->initializer584877d3e7563501587144->__invoke($this->valueHolder584877d3e750d320243087, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializer584877d3e7563501587144);

        return $this->valueHolder584877d3e750d320243087->newHydrator($hydrationMode);
    }
    ...
    {
        $this->initializer584877d3e7563501587144 && $this->initializer584877d3e7563501587144->__invoke($this->valueHolder584877d3e750d320243087, $this, 'getProxyFactory', array(), $this->initializer584877d3e7563501587144);

        return $this->valueHolder584877d3e750d320243087->getProxyFactory();
    }
    ...
    {
        $this->initializer584877d3e7563501587144 && $this->initializer584877d3e7563501587144->__invoke($this->valueHolder584877d3e750d320243087, $this, 'initializeObject', array('obj' => $obj), $this->initializer584877d3e7563501587144);

        return $this->valueHolder584877d3e750d320243087->initializeObject($obj);
    }
    ...
    {
        $this->initializer584877d3e7563501587144 && $this->initializer584877d3e7563501587144->__invoke($this->valueHolder584877d3e750d320243087, $this, 'getFilters', array(), $this->initializer584877d3e7563501587144);

        return $this->valueHolder584877d3e750d320243087->getFilters();
    }
    ...
    {
        $this->initializer584877d3e7563501587144 && $this->initializer584877d3e7563501587144->__invoke($this->valueHolder584877d3e750d320243087, $this, 'isFiltersStateClean', array(), $this->initializer584877d3e7563501587144);

        return $this->valueHolder584877d3e750d320243087->isFiltersStateClean();
    }
    ...
    {
        $this->initializer584877d3e7563501587144 && $this->initializer584877d3e7563501587144->__invoke($this->valueHolder584877d3e750d320243087, $this, 'hasFilters', array(), $this->initializer584877d3e7563501587144);

        return $this->valueHolder584877d3e750d320243087->hasFilters();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializer584877d3e7563501587144 = $initializer;
    ...
    protected function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, \Doctrine\Common\EventManager $eventManager)
    {
        ...
        if (! $this->valueHolder584877d3e750d320243087) {
            $reflection = $reflection ?: new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHolder584877d3e750d320243087 = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        ...
        $this->valueHolder584877d3e750d320243087->__construct($conn, $config, $eventManager);
    }
    ...
    {
        $this->initializer584877d3e7563501587144 && $this->initializer584877d3e7563501587144->__invoke($this->valueHolder584877d3e750d320243087, $this, '__get', ['name' => $name], $this->initializer584877d3e7563501587144);

        if (isset(self::$publicProperties584877d3e73fb012505106[$name])) {
            return $this->valueHolder584877d3e750d320243087->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder584877d3e750d320243087;
    ...
    {
        $this->initializer584877d3e7563501587144 && $this->initializer584877d3e7563501587144->__invoke($this->valueHolder584877d3e750d320243087, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer584877d3e7563501587144);
    ...
    {
        $this->initializer584877d3e7563501587144 && $this->initializer584877d3e7563501587144->__invoke($this->valueHolder584877d3e750d320243087, $this, '__isset', array('name' => $name), $this->initializer584877d3e7563501587144);
    ...
    {
        $this->initializer584877d3e7563501587144 && $this->initializer584877d3e7563501587144->__invoke($this->valueHolder584877d3e750d320243087, $this, '__unset', array('name' => $name), $this->initializer584877d3e7563501587144);
    ...
    {
        $this->initializer584877d3e7563501587144 && $this->initializer584877d3e7563501587144->__invoke($this->valueHolder584877d3e750d320243087, $this, '__clone', array(), $this->initializer584877d3e7563501587144);

        $this->valueHolder584877d3e750d320243087 = clone $this->valueHolder584877d3e750d320243087;
    }

    public function __sleep()
    {
        $this->initializer584877d3e7563501587144 && $this->initializer584877d3e7563501587144->__invoke($this->valueHolder584877d3e750d320243087, $this, '__sleep', array(), $this->initializer584877d3e7563501587144);

        return array('valueHolder584877d3e750d320243087');
    }
    ...
    {
        $this->initializer584877d3e7563501587144 = $initializer;
    }
    ...
    {
        return $this->initializer584877d3e7563501587144;
    }
    ...
    {
        return $this->initializer584877d3e7563501587144 && $this->initializer584877d3e7563501587144->__invoke($this->valueHolder584877d3e750d320243087, $this, 'initializeProxy', array(), $this->initializer584877d3e7563501587144);
    }
    ...
    {
        return null !== $this->valueHolder584877d3e750d320243087;
    }
    ...
    {
        return $this->valueHolder584877d3e750d320243087;
    }
